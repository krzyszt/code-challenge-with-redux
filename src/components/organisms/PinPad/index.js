...
import storeProvider from './pinpad-container';
...
class PinPad extends Component {
  static propTypes = {
    ...
    validPin: PropTypes.bool,
    attepmts: PropTypes.number
  };
  ...
  render() {
    ...
    return (
        <PinPadForm action="" method="" autoComplete="off">
          ...
          <br/>
          { [1, 2, 3].map(i => <PinPadButton key={i} val={i} locked={this.props.locked} setValue={this.addNumber} />)}
          <br/>
          { [4, 5, 6].map(i => <PinPadButton key={i} val={i} locked={this.props.locked} setValue={this.addNumber} />)}
          <br/>
          { [7, 8, 9].map(i => <PinPadButton key={i} val={i} locked={this.props.locked} setValue={this.addNumber} />)}
          <br/>
          <PinPadButton empty />
          <PinPadButton val={0} locked={this.props.locked} setValue={this.addNumber} />
          <PinPadButton empty />
        </PinPadForm>
    );
  }
...
export default storeProvider(PinPad);
